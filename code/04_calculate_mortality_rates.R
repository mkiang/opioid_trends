...
## Get data ----
all_data <-
    read.csv(sprintf('%s/working_opioid_data.csv', csv_folder),
...
write.csv(age_spec_rates,
          sprintf("%s/age_specific_rates.csv", csv_folder),
          row.names = FALSE)

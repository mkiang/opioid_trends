---
title: "eTable 6. Joinpoint results by broad opioid type, black population, 1979-2015"
...
# eTable 6: Joinpoint results in black population by broad opioid type, 1979-2015
## Average APC
```{r echo=FALSE, message=FALSE}
knitr::kable(types_aapc %>% filter(Race == "Black"))
```

## Joinpoint Summary (Jump model) 
```{r echo=FALSE, message=FALSE}
knitr::kable(types_apc %>% filter(Race == "Black"))
```

## Joinpoint Model Estimates
### Estimates
```{r echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(model_estimates %>% filter(Race == "Black")) 
```

### Summary
```{r echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(model_summary %>% filter(Race == "Black"))
```

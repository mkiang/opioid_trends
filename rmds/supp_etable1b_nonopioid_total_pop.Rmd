---
title: "eTable 1b. Joinpoint results for non-opioid drug deaths in the total population, 1979-2015"
...
# eTable 1b: Non-opioid drug deaths, total population, 1979-2015
## Average APC
```{r echo=FALSE, message=FALSE}
knitr::kable(opioids_aapc %>% filter(Outcome == "Non-opioid drug deaths"))
```

## Joinpoint Summary (Jump model) 
```{r echo=FALSE, message=FALSE}
knitr::kable(opioids_apc %>% filter(Outcome == "Non-opioid drug deaths"))
```
...
knitr::kable(model_estimates %>% filter(Race == "All", 
                                        Outcome == "Non-opioid drug deaths"))
```

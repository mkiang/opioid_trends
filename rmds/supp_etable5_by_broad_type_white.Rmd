---
title: "eTable 5. Joinpoint results by broad opioid type, white population, 1979-2015"
...
base_path <- paste0("./joinpoint_analysis/03_opioid_rates_by_type/", 
                    "03_opioid_rates_by_type")

## Average APC
types_aapc <- import_aapc_file(paste0(base_path, ".aapc.txt")) %>% 
    mutate(opioid_type = factor(opioid_type, 
                               levels = c("heroin", "methadone", "nonh_nonm"), 
                               labels = c("Heroin", "Methadone", 
                                          "Non-heroin, non-methadone opioid"), 
                               ordered = TRUE), 
           race = factor(race, 
...
## APC
types_apc <- import_jp_file(paste0(base_path, ".apc.txt")) %>% 
    mutate(opioid_type = factor(opioid_type, 
                               levels = c("heroin", "methadone", "nonh_nonm"), 
                               labels = c("Heroin", "Methadone", 
                                          "Non-heroin, non-methadone opioid"), 
...
# eTable 5: Joinpoint results in white population by broad opioid type, 1979-2015
## Average APC
```{r echo=FALSE, message=FALSE}
knitr::kable(types_aapc %>% filter(Race == "White"))
```

## Joinpoint Summary (Jump model) 
```{r echo=FALSE, message=FALSE}
knitr::kable(types_apc %>% filter(Race == "White"))
```
